...
""" Load a pre-trained model and test under perturbation matching Izawa and Shadmer, 2011 experimental set-up, BUT using dense rwds where rwd given always based on distance not only when reach within target area. This helps show the variance difference between RBL and EBL are not due to rwd density but the action gradient estimation process.
"""
...
for s in seeds:
    ...
    for beta in betas:
        ...
        label = "DenseRwd_Mixed_"+str(beta)
