...
class Actor(nn.Module):
    ...
    def __init__(self,input_s=1,action_s=1,ln_rate = 1e-3, opt_type='Adam'):
        ...
        nn.init.normal_(self.l1.weight, mean=0, std=0.01)  # Initialize with a small scale
        nn.init.normal_(self.l1.bias, mean=0, std=0.01)  # Initialize with a small scale
